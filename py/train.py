...
# 执行 SQL 查询
query = "SELECT age, gender, occupation, education_level, region, country, device, Fashion, Art, Entertainment, Education, Pets, Eco, Weather, Technology, Politics, Economy FROM user_train_data"
